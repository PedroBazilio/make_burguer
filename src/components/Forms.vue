<template>
<div>
    <p>Componenete de Mensagem</p>
</div>
<div id="burguer-form-div">
    <form id="burguer-form" @submit="createBurger">
        ...
        <div id="opcionais-container" class="input-container">
            <label id="opcionais-title" for="opcionais">Escolha os acompanhamentos</label>
...
<style scoped>
    ...
    label{
        ...
        color: rgb(77, 73, 73);
        padding: 5px 10px;
        border-left: 4px solid rgb(143, 109, 126);;
    }
